...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/unvisible.svg
  SvgGenImage get unvisible => const SvgGenImage('assets/icons/unvisible.svg');

  /// File path: assets/icons/visible.svg
  SvgGenImage get visible => const SvgGenImage('assets/icons/visible.svg');

  /// List of all assets
  List<SvgGenImage> get values => [arrowRight, unvisible, visible];
}
...
class $AssetsImagesGen {
  ...
  /// List of all assets
  List<AssetGenImage> get values => [bgSplash];
}
