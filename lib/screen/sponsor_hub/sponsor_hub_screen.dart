...
import 'package:flutter_bump_app/screen/sponsor_hub/tab/sponsorship/sponsorship_tab.dart';
...
class SponsorHubScreenState extends BaseBlocNoAppBarPageState<SponsorHubScreen,
    SponsorHubState, SponsorHubCubit> with SingleTickerProviderStateMixin {
  ...
  Widget buildBody(BuildContext context, SponsorHubCubit cubit) {
    return BlocConsumer<SponsorHubCubit, SponsorHubState>(
      listener: (context, state) {
        tabController.animateTo(
          state.selectedTab == SelectedTab.discover ? 0 : 1,
            ...
            child: Column(
              children: [
                ...
                Expanded(
                  ...
                  children: const [DiscoverTab(), SponsorshipTab()],
                )),
              ],
            ),
          ),
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: Center(
                      child: Text(
                        '${10}',
                        style: AppStyle.bold10(color: const Color(0xFF0F172A)),
                      ),
                    ),
                  ),
                ),
